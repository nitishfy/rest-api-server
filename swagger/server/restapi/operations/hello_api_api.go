...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		GetAPIAPIVersionHandler: GetAPIAPIVersionHandlerFunc(func(params GetAPIAPIVersionParams) middleware.Responder {
			return middleware.NotImplemented("operation GetAPIAPIVersion has not yet been implemented")
		}),
		GetImagesNameHandler: GetImagesNameHandlerFunc(func(params GetImagesNameParams) middleware.Responder {
			return middleware.NotImplemented("operation GetImagesName has not yet been implemented")
		}),
		GetUsersUserHandler: GetUsersUserHandlerFunc(func(params GetUsersUserParams) middleware.Responder {
			return middleware.NotImplemented("operation GetUsersUser has not yet been implemented")
		}),
...
/*HelloAPIAPI Rest API server in Go with Swagger endpoints definition. */
type HelloAPIAPI struct {
	...
	// GetAPIAPIVersionHandler sets the operation handler for the get API API version operation
	GetAPIAPIVersionHandler GetAPIAPIVersionHandler
	// GetImagesNameHandler sets the operation handler for the get images name operation
	GetImagesNameHandler GetImagesNameHandler
	// GetUsersUserHandler sets the operation handler for the get users user operation
	GetUsersUserHandler GetUsersUserHandler
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.GetAPIAPIVersionHandler == nil {
		unregistered = append(unregistered, "GetAPIAPIVersionHandler")
	}
	if o.GetImagesNameHandler == nil {
		unregistered = append(unregistered, "GetImagesNameHandler")
	}
	if o.GetUsersUserHandler == nil {
		unregistered = append(unregistered, "GetUsersUserHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/api/{api_version}"] = NewGetAPIAPIVersion(o.context, o.GetAPIAPIVersionHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/images/{name}"] = NewGetImagesName(o.context, o.GetImagesNameHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/users/{user}"] = NewGetUsersUser(o.context, o.GetUsersUserHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"][""] = NewCheckHealth(o.context, o.CheckHealthHandler)
}
